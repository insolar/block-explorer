...
func TestExtLog_ZerologCaller(t *testing.T) {
	...
	assert.NotContains(t, "github.com/insolar/block-explorer", lf.Caller, "log not contains package name")
